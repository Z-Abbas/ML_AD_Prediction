...
for index in range(5):
    ...
    filename = "K_Fold_Data_64/Integrated/"+str(index)+'_fold_finalized_model_NB.sav'
    ...
    training_acc = accuracy_score(train_y, nb.predict(train_X)) # Training Accuracy
...
for index in range(5):
    ...
    # *****save the model to disk *****
    filename = "K_Fold_Data_64/DEG/"+str(index)+'_fold_finalized_model_NB.sav'
    pickle.dump(nb, open(filename, 'wb'))
...
for index in range(5):
    ...
    # *****save the model to disk *****
    filename = "K_Fold_Data_64/DMP/"+str(index)+'_fold_finalized_model_NB.sav'
    pickle.dump(nb, open(filename, 'wb'))
    ...
    training_acc = accuracy_score(train_y, nb.predict(train_X))
    roc_auc = metrics.roc_auc_score(test_y.ravel(), predicted.ravel())
